...
delta123 = Flight.create(destination_id: destination.id, flight_date: 2020-05-11 16:40:00, price: 420.42, class: "business", flight_number: "Delta123")
...
daysinn = Hotel.create(destination_id: destination.id, star_rating: 1, guest_rating: 3, is_available?: true, name: "Days Inn")
mariottmarquis = Hotel.create(destination_id: destination.id, star_rating: 4, guest_rating: 10, is_available?: true, name: "The Mariott Marquis Times Square")
